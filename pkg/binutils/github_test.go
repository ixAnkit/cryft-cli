...
func TestGetGithubLatestReleaseURL(t *testing.T) {
	...
	expected := "https://api.github.com/repos/ava-labs/cryftgo/releases/latest"
	...
	tests := []urlTest{
		{
			...
			goarch:      "amd64",
			goos:        "linux",
			expectedURL: "https://github.com/ava-labs/cryftgo/releases/download/v1.17.1/cryftgo-linux-amd64-v1.17.1.tar.gz",
		...
		},
		{
			...
			goarch:      "arm64",
			goos:        "darwin",
			expectedURL: "https://github.com/ava-labs/cryftgo/releases/download/v1.18.5/cryftgo-macos-v1.18.5.zip",
		...
		},
		{
			...
			goarch:      "amd64",
			goos:        "windows",
			expectedURL: "https://github.com/ava-labs/cryftgo/releases/download/v2.1.4/cryftgo-win-v2.1.4-experimental.zip",
			expectedExt: zipExtension,
			expectedErr: nil,
		},
		{
